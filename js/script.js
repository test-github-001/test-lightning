...
background.src = "./src/images/clouds_sky.jpg";
...
class Dot {
    ...
    constructor() {
        ...
        this.color = this.isCharged ? 'rgb(255, 0, 0)' : 'rgb(0, 0, 255)';
...
const lightningColors = ['rgb(255,255,255)', 'rgb(255,0,255)', 'rgb(255,255,0)', 'rgb(205,92,92)']
